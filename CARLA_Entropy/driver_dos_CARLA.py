...
def pipeline_run(config):
    ...
    if steps.get("attack", False):
        ...
        from scripts.adversarial_attack_dos_final_CARLA import run as run_attack
    ...
    if steps.get("decode", False):
        ...
        from scripts.Traffic_decoder_dos_CARLA import run as run_decode
    ...
    if steps.get("evaluate", False):
        ...
        from scripts.evaluate_dos_CARLA import run as run_eval
    ...
    if steps.get("update", False):
        ...
        from scripts.update_labels_dos_CARLA import run as run_update
