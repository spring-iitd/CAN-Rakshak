...
def run(params):
    ...
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    existing_hex_ids = ['007F', '0130', '0140', '0153', '0160', '0164', '0220', '0251', '02B0', '0340', '0371', '0372', 
                        '0381', '0386', '0387', '0389', '038D', '0394', '0410', '0412', '0420', '0421', '0436', '0470', '047F', 
                        '0485', '0490', '0495', '04A2', '04C9', '04F1', '0500', '0507', '050A', '050B', '050C', '050E', '0520', '052A', '0541', '0544', 
                        '054B', '0553', '0559', '057F', '0592', '0593', '0595', '0596', '05B0', '05BE', '05C1', '05E3', '05FF']
